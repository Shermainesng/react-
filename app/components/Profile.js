...
function Profile() {
  ...
  //when user clicks on follow button to follow user
  ...
  //when user clicks on stop following button to unfollow user
  ...
  return (
    <Page title="Profile Screen">
      ...
      <div className="profile-nav nav nav-tabs pt-2 mb-4">
        {/* dont need to add route for the posts page because this component alr renders it, we're at /profile/username */}
        <NavLink to="" end className="nav-item nav-link">
          Posts: {state.profileData.counts.postCount}
        </NavLink>
        {/* add an end prop to ensure that the link isn't considered active when its descendant url are visible */}
